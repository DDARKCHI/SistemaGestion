...
@section('content')
    ...
    <div class="fault-form-header">
        ...
        <p class="fault-form-subtitle">
            Modifica los antecedentes registrados para esta falta.
        </p>
    ...
    <section class="fault-form-card">
        ...
        <div class="fault-form-card-header">
            ...
            <p class="fault-form-card-description">
                Actualiza la fecha, tipo, estado y antecedentes relacionados con la falta.
            </p>
        ...
        <form
            action="{{ route('trabajadores.faltas.update', ['trabajador' => $trabajador, 'falta' => $falta]) }}"
            method="POST"
        >
            ...
            <div class="fault-form-body">
                ...
                <div class="fault-form-grid">
                    ...
                    <div class="fault-form-group">
                        ...
                        <input
                            ...
                            value="{{ old('fecha', $falta->fecha ? $falta->fecha->format('Y-m-d') : '') }}"
                            required
                            autofocus
                        >
                    ...
                    <div class="fault-form-group">
                        ...
                        >
                            ...
                            <option
                                value="registrada"
                                {{ old('estado', $falta->estado) === 'registrada' ? 'selected' : '' }}
                            >
                                Registrada
                            </option>
                            ...
                            <option
                                value="pendiente"
                                {{ old('estado', $falta->estado) === 'pendiente' ? 'selected' : '' }}
                            >
                                Pendiente
                            </option>
                            ...
                            <option
                                value="sancionada"
                                {{ old('estado', $falta->estado) === 'sancionada' ? 'selected' : '' }}
                            >
                                Sancionada
                            </option>
                            ...
                            <option
                                value="cerrada"
                                {{ old('estado', $falta->estado) === 'cerrada' ? 'selected' : '' }}
                            >
                                Cerrada
                            </option>
                    ...
                    <div class="fault-form-group fault-form-group-full">
                        ...
                        >{{ old('descripcion', $falta->descripcion) }}</textarea>
                    ...
                    <div class="fault-form-group fault-form-group-full">
                        ...
                        >{{ old('sancion', $falta->sancion) }}</textarea>
                    ...
                    <div class="fault-form-group fault-form-group-full">
                        ...
                        >{{ old('observaciones', $falta->observaciones) }}</textarea>
                ...
                <div class="fault-form-info">
                    ...
                    puedes mantener la falta como registrada, dejarla pendiente, marcarla como sancionada o cerrarla cuando corresponda.
