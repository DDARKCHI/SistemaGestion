...
@section('title', 'Nuevo período de vacaciones')
...
<style>
    ...
    .vacation-form-input::placeholder {
        color: #a1aab7;
    }
...
@section('content')
    ...
    <div class="vacation-form-header">
        ...
        <p class="vacation-form-subtitle">
            Registra los días de vacaciones correspondientes al trabajador.
        </p>
    ...
    @if($errors->any())
        ...
        <div class="vacation-form-alert">
            ...
            corrección antes de guardar el período de vacaciones.
        </div>
    ...
    <section class="vacation-form-card">
        ...
        <div class="vacation-form-card-header">
            ...
            <p class="vacation-form-card-description">
                Define el período y la cantidad de días disponibles.
            </p>
        ...
        <form
            action="{{ route('trabajadores.vacaciones.store', $trabajador) }}"
            method="POST"
        >
            ...
            <div class="vacation-form-body">
                ...
                <div class="vacation-form-grid">
                    ...
                    <div class="vacation-form-group">
                        ...
                        <div class="vacation-form-help">
                            Identifica el período al que corresponden las vacaciones.
                        </div>
                    ...
                    <div class="vacation-form-group">
                        ...
                        <input
                            ...
                            class="vacation-form-input"
                            value="{{ old('dias_correspondientes') }}"
                            placeholder="Ej. 15"
                            min="0"
                            step="0.5"
                            required
                        ...
                        <div class="vacation-form-help">
                            Total de días disponibles para este período.
                        </div>
                ...
                <div class="vacation-form-info">

                    <strong>
                        Estado inicial:
                    </strong>

                    el período se registrará como
                    <strong>No tomadas</strong>.

                    Los días tomados y reservados comenzarán en 0 y
                    los días restantes serán calculados automáticamente
                    según los días correspondientes.
