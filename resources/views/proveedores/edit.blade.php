        ...
        <div class="provider-edit-header-left">
            ...
            <div>
                ...
                <p class="provider-edit-subtitle">
                    Actualiza los antecedentes de {{ $proveedor->nombre }}.
                </p>
                ...
                <div class="provider-form-grid">
                    ...
                    <div class="provider-form-group">
                        ...
                        <input
                            ...
                            name="localidad"
                            class="provider-form-control"
                            value="{{ old('localidad', $proveedor->localidad) }}"
                            maxlength="100"
                    ...
                    <div class="provider-form-group">
                        ...
                        <input
                            ...
                            name="cuenta"
                            class="provider-form-control"
                            value="{{ old('cuenta', $proveedor->cuenta) }}"
                            maxlength="100"
