...
@section('topbar_title', 'Editar remuneración')
...
<style>
    ...
    .remuneracion-existing-documents {
        margin-bottom: 14px;
    }

    .remuneracion-existing-document {
        display: flex;
        align-items: center;
        justify-content: space-between;
        gap: 12px;
    ...
    .remuneracion-existing-document-info {
        min-width: 0;
    }

    .remuneracion-existing-document-name {
        color: #344054;
        font-size: 10px;
        font-weight: 700;
    ...
    .remuneracion-existing-document-type {
        margin-top: 2px;
        color: #98a2b3;
        font-size: 9px;
    }

    .remuneracion-existing-document-link {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        min-height: 29px;
    ...
    .remuneracion-existing-document-link:hover {
        background: #f5f8fb;
    }
...
@section('content')
    ...
    <div class="remuneracion-create-header">
        <div>
            ...
            <p class="remuneracion-create-subtitle">
                Actualiza los montos, pagos y antecedentes de esta remuneración.
            </p>
        </div>
    ...
    @if($errors->any())
        <div class="remuneracion-create-alert">
            <strong>
                No se pudo actualizar la remuneración.
            </strong>
    ...
    <section class="remuneracion-create-card">
        ...
        <form
            action="{{ route(
                'trabajadores.remuneraciones.update',
                [
                    $trabajador,
                    $remuneracion
                ]
            ...
            <div class="remuneracion-create-grid">
                ...
                <div class="remuneracion-create-field">
                    ...
                    <input
                        ...
                        value="{{ old('periodo', $remuneracion->periodo) }}"
                ...
                <div class="remuneracion-create-field">
                    ...
                    <div class="remuneracion-create-help">
                        Monto base utilizado para calcular esta remuneración.
                    </div>
                ...
                <div class="remuneracion-create-field">
                    ...
                    <div class="remuneracion-create-help">
                        Permite modificar un pago parcial o registrar el pago completo.
                    </div>
                ...
                {{-- ESTADO --}}
                <div class="remuneracion-create-field">
                    <label class="remuneracion-create-label">
                        Estado de pago
                    </label>
                ...
                <div class="remuneracion-create-field remuneracion-create-field-full">
                    ...
                    <div class="remuneracion-create-upload">
                        ...
                        <p class="remuneracion-create-upload-text">
                            Los documentos existentes se mantienen asociados.
                            Si adjuntas un nuevo archivo, se agregará al historial
                            de esta remuneración.
                        </p>

                        @if(
                            $remuneracion->relationLoaded('documentos') &&
                            $remuneracion->documentos->isNotEmpty()
                        )
                            <div class="remuneracion-existing-documents">

                                @foreach(
                                    $remuneracion->documentos
                                    as $documento
                                )
                                    <div class="remuneracion-existing-document">

                                        <div class="remuneracion-existing-document-info">

                                            <div class="remuneracion-existing-document-name">
                                                {{ $documento->nombre }}
                                            </div>

                                            <div class="remuneracion-existing-document-type">
                                                {{ $documento->tipo ?? 'Documento de remuneración' }}
                                            </div>
                                        ...
                                        @if($documento->ruta)
                                            <a
                                                ...
                                                target="_blank"
                                                class="remuneracion-existing-document-link"
                                            >
                                                Abrir archivo
                                            </a>
                                        @endif
                        ...
                        @else
                            <div class="remuneracion-create-help" style="margin-bottom: 12px;">
                                Esta remuneración no tiene documentos asociados.
                            </div>
                        @endif
                        ...
                        <div class="remuneracion-create-help">
                            PDF, imagen, Word o Excel. Máximo 20 MB.
                        </div>
        ...
        function () {
            ...
            function actualizarCalculos() {
                ...
                const bonificaciones =
                    numero(
                        bonificacionesInput.value
                    );

                const descuentos =
                    numero(
                        descuentosInput.value
                    );
