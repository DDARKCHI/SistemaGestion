                        ...
                        @foreach($documentos as $documento)
                            ...
                            @php
                                ...
                                if ($registro) {
                                    ...
                                    if ($documento->documentable_type === \App\Models\Operacion::class) {
                                    ...
                                    elseif ($documento->documentable_type === \App\Models\Entrega::class) {
                                    ...
                                    elseif ($documento->documentable_type === \App\Models\Trabajador::class) {
                                    ...
                                    elseif ($documento->documentable_type === \App\Models\Contrato::class) {
                                    ...
                                    elseif ($documento->documentable_type === \App\Models\ModificacionContrato::class) {

                                        $tipoRegistro = 'Modificación';

                                        $nombreRegistro =
                                            'Modificación #' . $registro->id;

                                    }

                                    elseif ($documento->documentable_type === \App\Models\Permiso::class) {
