...
<head>
    ...
    <title>Editar entrega - Sistema de Gestión</title>
                ...
                <div class="campo campo-completo">
                    ...
                    <div class="buscador-operacion">
                        ...
                        <input
                            ...
                            autocomplete="off"
                            value="{{ old('operacion_id') ? '' : $entrega->operacion->numero_operacion . ' - ' . $entrega->operacion->cliente->razon_social }}"
                        >
                    ...
                    >
                        ...
                        <span id="texto_operacion_seleccionada">
                            ...
                            @if (old('operacion_id'))
                                ...
                                @php
                                    $operacionAnterior = $operaciones->firstWhere(
                                        'id',
                                        old('operacion_id')
                                    );
                                @endphp
                                ...
                                @if ($operacionAnterior)
                                    ...
                                    -
                                    {{ $operacionAnterior->cliente->razon_social }}
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Recuperar la operación después de una
        // validación fallida.
