...
@section('content')
    ...
    <div class="absence-form-header">
        ...
        <p class="absence-form-subtitle">
            Registra una ausencia y sus antecedentes para el trabajador.
        </p>
    ...
    @if($errors->any())
        ...
        <div class="absence-form-alert">
            Revisa los datos ingresados. Hay campos que requieren corrección antes de guardar la ausencia.
        </div>
    ...
    <section class="absence-form-card">
        ...
        <div class="absence-form-card-header">
            ...
            <p class="absence-form-card-description">
                Define las fechas, cantidad de días y estado de la ausencia.
            </p>
        ...
        <form
            action="{{ route('trabajadores.ausencias.store', $trabajador) }}"
            method="POST"
        >
            ...
            <div class="absence-form-body">
                ...
                <div class="absence-form-grid">
                    ...
                    <div class="absence-form-group">
                        ...
                        >
                            ...
                            <option
                                value="justificada"
                                {{ old('estado') === 'justificada' ? 'selected' : '' }}
                            >
                                Justificada
                            </option>
                            ...
                            <option
                                value="injustificada"
                                {{ old('estado') === 'injustificada' ? 'selected' : '' }}
                            >
                                Injustificada
                            </option>
                ...
                <div class="absence-form-info">
                    ...
                    permite registrar inicialmente la ausencia y definir posteriormente si corresponde como justificada o injustificada.
