...
@section('topbar_title', 'Nueva nota de crédito de proveedor')
...
@section('content')
    ...
    <div class="credit-note-form-header">
        ...
        <div>
            ...
            <p class="credit-note-form-subtitle">
                Registra una nota de crédito pendiente de recuperar de un proveedor.
            </p>
    ...
    <section class="credit-note-form-card">
        ...
        <div class="credit-note-form-card-header">
            ...
            <div>
                ...
                <p class="credit-note-form-card-description">
                    Ingresa los antecedentes necesarios para mantener el registro.
                </p>
        ...
        <form
            action="{{ route('notas-credito-proveedores.store') }}"
            method="POST"
        >
            ...
            <div class="credit-note-form-body">
                ...
                <div class="credit-note-form-info">
                    ...
                    <p class="credit-note-form-info-text">
                        La nota quedará asociada directamente al proveedor seleccionado.
                        El RUT se obtiene automáticamente desde sus datos registrados.
                    </p>
                ...
                <div class="credit-note-form-grid">
                    ...
                    <div class="credit-note-form-group">
                        ...
                        >
                            ...
                            <span class="credit-note-required">
                                *
                            </span>
                        ...
                        <div class="credit-note-form-help">
                            El RUT se carga automáticamente al seleccionar el proveedor.
                        </div>
                    ...
                    <div class="credit-note-form-group">
                        ...
                        <div class="credit-note-form-help">
                            Monto total de la nota de crédito pendiente de recuperar.
                        </div>
                    ...
                    <div class="credit-note-form-group">
                        ...
                        >
                            ...
                            <option
                                value="recuperada"
                                {{ old('estado') === 'recuperada' ? 'selected' : '' }}
                            >
                                Recuperada
                            </option>
                    ...
                    <div class="credit-note-form-group credit-note-form-group-full">
                        ...
                        <textarea
                            ...
                            placeholder="Ingrese información adicional relacionada con la recuperación de la nota..."
