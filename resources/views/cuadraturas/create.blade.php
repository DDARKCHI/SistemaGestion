...
@section('title', 'Nueva cuadratura')
...
@section('content')
    ...
    <div class="quadrature-form-header">
        ...
        <p class="quadrature-form-subtitle">
            Registra los totales asociados al trabajador y a una operación.
        </p>
    ...
    @if($errors->any())
        ...
        <div class="quadrature-form-alert">
            Revisa los datos ingresados. Hay campos que requieren corrección antes de guardar la cuadratura.
        </div>
    ...
    <section class="quadrature-form-card">
        ...
        <div class="quadrature-form-card-header">
            ...
            <p class="quadrature-form-card-description">
                Registra la operación, período y los totales correspondientes.
            </p>
        ...
        <form
            action="{{ route('trabajadores.cuadraturas.store', $trabajador) }}"
            method="POST"
        >
            ...
            <div class="quadrature-form-body">
                ...
                <div class="quadrature-form-grid">
                    ...
                    <div class="quadrature-form-group">
                        ...
                        >
                            ...
                            @foreach($operaciones as $operacion)
                                ...
                                <option
                                    value="{{ $operacion->id }}"
                                    {{ (string) old('operacion_id') === (string) $operacion->id ? 'selected' : '' }}
                                >
                    ...
                    <div class="quadrature-form-group">
                        ...
                        <input
                            ...
                            class="quadrature-form-input quadrature-calculate"
                            value="{{ old('gastos_sin_comprobante', 0) }}"
                            min="0"
                            step="0.01"
                            required
                        >
                ...
                <div class="quadrature-form-info">
                    ...
                    la cuadratura registra totales asociados al trabajador y a la operación.
                    Los saldos se calculan utilizando el dinero depositado y los gastos registrados.
