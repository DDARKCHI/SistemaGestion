...
<div class="factura-form-page">
    ...
    <div class="factura-form-header">
        ...
        <p>
            Registra una factura y asóciala directamente con una operación.
        </p>
                ...
                <div class="factura-form-grid">
                    ...
                    <div class="factura-form-group">
                        ...
                        >
                            ...
                            <span id="operacionCliente">-</span>

                            &nbsp;&nbsp;|&nbsp;&nbsp;

                            <strong>Fecha operación:</strong>

                            <span id="operacionFecha">-</span>
                ...
                <div class="factura-form-grid">
                    ...
                    <div class="factura-form-group">
                        ...
                        >
                            ...
                            <option
                                value="reemplazada"
                                {{ old('estado') === 'reemplazada' ? 'selected' : '' }}
                            >
                                Reemplazada
                            </option>
                    ...
                    <div class="factura-form-group">
                        ...
                        >
                            ...
                            <option
                                value="sin_mora"
                                {{ old('estado_mora', 'sin_mora') === 'sin_mora' ? 'selected' : '' }}
                            >
                                Sin mora
                            </option>
                            ...
                            <option
                                value="con_mora"
                                {{ old('estado_mora') === 'con_mora' ? 'selected' : '' }}
                            >
                                Con mora
                            </option>
                        ...
                        <div class="factura-form-help">
                            Este estado podrá complementarse posteriormente
                            con el registro detallado de la mora.
                        </div>
                    ...
                    <div class="factura-form-group full">
                        ...
                        >
                            ...
                            @foreach($facturas as $facturaAnterior)
                                ...
                                <option
                                    ...
                                    {{ old('factura_reemplazada_id') == $facturaAnterior->id ? 'selected' : '' }}
                                >
                        ...
                        <div class="factura-form-help">
                            Utiliza este campo únicamente cuando la nueva factura
                            reemplaza a una factura anterior.
                        </div>
            ...
            <div class="factura-form-body">
                ...
                <div class="factura-form-grid">
                    ...
                    <div class="factura-form-group">
                        ...
                        <div class="factura-form-help">
                            Se completa cuando el pago de la factura haya sido realizado.
                        </div>
                    ...
                    <div class="factura-form-group">
                        ...
                        <div class="factura-form-help">
                            Permite registrar cuándo la factura quedó completamente cerrada.
                        </div>
